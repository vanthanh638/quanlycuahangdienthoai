                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 register-account">
                            ...
                            <div class="page-content">
                            	<form action="${pageContext.request.contextPath}/admincp/loai-phu-kien/edit/${objLoaiPK.id_loai_pk}" method="post" enctype="multipart/form-data">
	                            	<div class="row">
	                            	...
	                            	<div class="row">
	                                    <div class="col-lg-3 col-md-3 col-sm-3">
	                                    	<p>Tên loại phụ kiên</p>
	                                    </div>
	                                    <div class="col-lg-9 col-md-9 col-sm-9">
	                                    	<input type="text" name="name_loai_pk" value="${objLoaiPK.name_loai_pk}">
	                                    </div>	
	                                </div>
